...
import {MainContainer, LeftContainer, RightContainer, TextContainer, Heading, Text, Image , Input, Input1, CheckBox, Check, Label,FormHeading,SelectionContainer, ButtonText, ButtonPic, ButtonOptipn} from './StyledWanted'
    ...
    <MainContainer>
        <LeftContainer>
            ...
            <CheckBox>
                ...
                name='checkbox'
                />
                <Label>LOGO Hizmet Şartları'nı okudum ve kabul ediyorum</Label>
            </CheckBox>
            <Button
            btntype="Main"
            eb
        ...
        <RightContainer>
            <TextContainer>
                ...
                <Text>Türkiye'de ilk defa uzman bir ekibi sadece 3 tıkla harekete geçirin
İhtiyacınız olan mülkleri tamamen güvenli ve şeffaf bir şekilde bulun
işlemler</Text>
            </TextContainer>
